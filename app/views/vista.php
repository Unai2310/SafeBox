...
<html>
    ...
    <body style="background-image: url('/safebox/web/resources/texture3.png');">
        ...
        <div class="notesmall">
            ...
            <button class="botoncambio">Cambiar Acceso</button>

            <button class="botoncambio">Borrar</button>

            <p style="font-size: 14px; display: none;" class="opcioneseleccion" id="opselec">
                <a href="#" class="botonlink" id="seltodo">Seleccionar Todo</a> 
                <a href="#" class="botonlink" id="selnada">Deseleccionar Todo</a>
            </p>
